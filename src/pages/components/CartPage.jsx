      ...
      <div className="mx-auto px-4 py-16">
        <div className="max-w-md mx-auto text-center">
          ...
          <Button
            ...
            className="bg-[#D9C88A] text-white px-8 py-3 rounded-xl hover:bg-[#D9C88A] transition-colors"
          >
            Start Shopping
          </Button>
        </div>
      ...
      <div className="grid lg:grid-cols-3 gap-8">
          ...
          {cart.map((item,index) => (
            <div key={index} className="bg-white rounded-xl shadow-sm p-4 flex gap-4">
              ...
              <div className="flex flex-col items-end justify-between">
                <span className="text-xl text-[#D9C88A]">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24">
            ...
            {getCartTotal() < 50 && (
              <div className="bg-[#D9C88A] border border-[#D9C88A] rounded-lg p-3 mb-4 text-sm text-[#D9C88A]">
              ...
              <Button 
                  ...
                  disabled={loading}
                  className="w-full bg-[#D9C88A] text-white py-4 rounded-xl hover:bg-[#a98913] disabled:opacity-50"
                >
