      ...
      <div className="mx-auto px-4 py-4">
        <div className="flex items-center justify-between gap-4">
          ...
          {role === 'customer' && (
              ...
              <Button onClick={() => onNavigate('home')} className={currentPage === 'home' ? 'text-[#8A7432]' : 'hover:text-[#D9C88A]'}> Home </Button>
              <Button onClick={() => onNavigate('products')} className={currentPage === 'products' ? 'text-[#8A7432]' : 'hover:text-[#D9C88A]'}> Products</Button>
              <Button onClick={() => onScroll('about')} className="hover:text-[#D9C88A]">  About </Button>
              <Button onClick={() => onScroll('contact')} className="hover:text-[#D9C88A]">  Contact </Button>
